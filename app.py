...
<img src="data:image/png;base64,""" + logo_b64 + """\" style="height: 3.2rem; margin-bottom: 0.75rem; filter: drop-shadow(0 4px 12px rgba(123,47,247,0.3)); border-radius: 12px;">
<div class="login-title">Welcome Back</div>
<div class="login-sub">Sign in or create an account to start your free trial.</div>
